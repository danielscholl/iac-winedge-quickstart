...
. { Invoke-WebRequest -useb https://raw.githubusercontent.com/danielscholl/iac-winedge-quickstart/master/scripts/IotEdgeSecurityDaemon.ps1.ps1 } | Invoke-Expression; `
