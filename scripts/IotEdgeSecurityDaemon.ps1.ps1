New-Module -Name IoTEdge -ScriptBlock {
  ...
  Set-Variable ReleaseTAG -Value "1.0.8-rc3" -Option Constant
  ...
  function Get-IoTEdge([ref] $RestartNeeded, [bool] $Update) {
      try {
          ...
          $releaseURL= "https://github.com/Azure/azure-iotedge/releases/download/$ReleaseTAG/Microsoft-Azure-IoTEdge.cab"
